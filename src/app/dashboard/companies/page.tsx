...
import { Plus, Search, Building, Mail, Phone, Edit, Trash2, MapPin } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your company profiles</p>
          </div>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-gray-600 mb-6 text-center max-w-md">
                {companies.length === 0
                  ? "Add your company details to include sender information on invoices."
